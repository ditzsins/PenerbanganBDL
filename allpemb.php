...
<?php
	...
	if(isset($_POST['simpan']))
	{
		...
		$query = "SELECT year(tgl_pesan), nama_mitra, (SUM(total_harga)*2.5/100) FROM metode_bayar, pesanan WHERE pesanan.id_metode = metode_bayar.id_metode AND year(tgl_pesan) BETWEEN $periode_tahun and $sampai_tahun GROUP BY year(tgl_pesan), nama_mitra ORDER BY year(tgl_pesan) asc, (SUM(total_harga)*2.5/100) desc";
	...
	<div class = "container">
		...
		<div class="col-md-12" align="left">
			...
			<ul class="nav navbar-nav navbar-right" style="float: left; width: 20%;">
				<form action="allpembdownload.php" method="post" style="float: left; width: 10%;">
					<input type="hidden" name="query" value="<?php echo $query ?>" >
					<input type="image" src ="images/download.png" width = "40" alt="download" />
				</form>
				<a href="allpembgrafik.php" style="float: right; width: 80%;">
		...
		<div align = "center">
			<h2>Total Fee Mitra Pembayaran Per-Tahun</h2>
		</div>
		<br>
