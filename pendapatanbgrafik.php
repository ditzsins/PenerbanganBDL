...
<body>
	...
	<div class="container-fluid"> 
		<div class="col-md-6" class="graph"> 
			<p align="center" style="font-weight: bold;">Grafik Pendapatan Bersih Tahun 2016</p>
			<canvas id="canvas" height="350" width="700"></canvas>
			<script>
			$(document).ready(function(){
				$.ajax({
					url: "http://localhost/penerbangan2/pendapatanbgrafik2016.php",
					method: "GET",
		...
		<div class="col-md-6" class="graph" style="text-align: right;"> 
	   		<p align="center" style="font-weight: bold;">Grafik Pendapatan Bersih Tahun 2017</p>
			<canvas id="canvas2" height="350" width="700"></canvas>
			<script>
			$(document).ready(function(){
				$.ajax({
					url: "http://localhost/penerbangan2/pendapatanbgrafik2017.php",
					method: "GET",
					success: function(data) 
					{
						console.log(data);
						...
						var myLine = new Chart(document.getElementById("canvas2").getContext("2d")).Line(barChartData);
					},
					error: function(data) 
					{
						console.log(data);
...
<div class="container-fluid"> 
		<div class="col-md-6" class="graph"> 
			<p align="center" style="font-weight: bold;">Grafik Pendapatan Bersih Tahun 2018</p>
			<canvas id="canvas3" height="350" width="700"></canvas>
			<script>
			$(document).ready(function(){
				$.ajax({
					url: "http://localhost/penerbangan2/pendapatanbgrafik2018.php",
					method: "GET",
					success: function(data) 
					{
						console.log(data);
						...
						var myLine = new Chart(document.getElementById("canvas3").getContext("2d")).Line(barChartData);
					},
					error: function(data) 
					{
						console.log(data);
		...
		<div class="col-md-6" class="graph" style="text-align: right;"> 
	   		<p align="center" style="font-weight: bold;">Grafik Pendapatan Bersih Tahun 2019</p>
			<canvas id="canvas4" height="350" width="700"></canvas>
			<script>
			$(document).ready(function(){
				$.ajax({
					url: "http://localhost/penerbangan2/pendapatanbgrafik2019.php",
					method: "GET",
					success: function(data) 
					{
						console.log(data);
						...
						var myLine = new Chart(document.getElementById("canvas4").getContext("2d")).Line(barChartData);
					},
					error: function(data) 
					{
						console.log(data);
