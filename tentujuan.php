      ...
      <div class="collapse navbar-collapse" id="myNavbar">
		...
		<div class="col-md-12" align="left">
			...
			<ul class="nav navbar-nav navbar-right" style="float: left; width: 20%;">
				<form action="tentujuandownload.php" method="post" style="float: left; width: 10%;">
				...
				<a href="tentujuangrafik.php" style="float: right; width: 80%;">
		...
		<br><br>
			...
			<div align = "center">
				<h2>10 Tujuan Penerbangan Terfavorit Per-Tahun</h2>
			</div> 
			<br>
			<div class = "col-md-12">   
