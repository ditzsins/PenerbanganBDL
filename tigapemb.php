      ...
      <div class="collapse navbar-collapse" id="myNavbar">
		...
		<div class="col-md-12" align="left">
			...
			<ul class="nav navbar-nav navbar-right" style="float: left; width: 20%;">
				<form action="tigapembdownload.php" method="post" style="float: left; width: 10%;">
				...
				<a href="tigapembgrafik.php" style="float: right; width: 80%;">
		...
		<br><br>
			...
			<div align = "center">
				<h2>3 Mitra Pembayaran Tertinggi Per-Tahun</h2>
			</div> 
			<br>
			<div class = "col-md-12">   
