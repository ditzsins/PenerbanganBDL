...
<body>
	...
	<div class="container-fluid"> 
		<div class="col-md-6" class="graph"> 
			<p align="center" style="font-weight: bold;">Grafik Tiga Mitra Pembayaran Tertinggi Tahun 2016</p>
			<canvas id="canvas" height="350" width="700"></canvas>
			<script>
				$(document).ready(function(){
					$.ajax({
						url: "http://localhost/penerbangan2/tigapembgrafik2016.php",
						method: "GET",
		...
		<div align="right" class="col-md-6" class="graph"> 
			<p align="center" style="font-weight: bold;">Grafik Tiga Mitra Pembayaran Tertinggi Tahun 2017</p>
			<canvas id="canvas2" height="350" width="700"></canvas>
			<script>
				$(document).ready(function(){
					$.ajax({
						url: "http://localhost/penerbangan2/tigapembgrafik2017.php",
						method: "GET",
						success: function(data) 
						{
							console.log(data);
...
<div class="container-fluid"> 
		<div class="col-md-6" class="graph"> 
			<p align="center" style="font-weight: bold;">Grafik Tiga Mitra Pembayaran Tertinggi Tahun 2018</p>
			<canvas id="canvas3" height="350" width="700"></canvas>
			<script>
				$(document).ready(function(){
					$.ajax({
						url: "http://localhost/penerbangan2/tigapembgrafik2018.php",
						method: "GET",
						success: function(data) 
						{
							console.log(data);
		...
		<div align="right" class="col-md-6" class="graph"> 
			<p align="center" style="font-weight: bold;">Grafik Tiga Mitra Pembayaran Tertinggi Tahun 2019</p>
			<canvas id="canvas4" height="350" width="700"></canvas>
			<script>
				$(document).ready(function(){
					$.ajax({
						url: "http://localhost/penerbangan2/tigapembgrafik2019.php",
						method: "GET",
						success: function(data) 
						{
							console.log(data);
